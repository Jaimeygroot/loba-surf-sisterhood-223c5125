...
export default function OurMission() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            <div className="space-y-5 text-lg text-muted-foreground leading-relaxed">
              <p>
                I started surfing in 2007. My older brother handed me a board that was way too big and way too thin, a board he had brought back from Hawaii. My little brother and I paddled out almost every day after that. What started as curiosity quickly turned into a lifestyle. My younger brother would eventually become Dutch national champion, and I became one of the few girls in our village who kept going long enough to surf competitions.
              </p>
              <p>
                Over the years, surfing took me around the world. I've taught surf lessons for many different schools since 2010 in the Netherlands, France, Spain, Portugal, and Panama. I spent long periods traveling through Indonesia and Central America, chasing waves and learning from different surf cultures.
              </p>
          ...
          <ScrollReveal delay={0.2}>
            <div className="overflow-hidden rounded-3xl">
              <img
                src={youngSurfers}
                alt="Young surfers in the ocean"
      ...
      {/* Background Story - Part 2: The turning point */}
      <section className="py-16 px-6 md:px-12 lg:px-20 bg-muted">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal delay={0.2}>
            <div className="space-y-5 text-lg text-muted-foreground leading-relaxed order-1 lg:order-2">
              <p className="font-heading font-bold text-foreground text-xl">
      ...
      {/* Background Story - Part 3: The shift */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal delay={0.2}>
            <div className="overflow-hidden rounded-3xl">
              <img
                src={robinLane}
                alt="Surf etiquette illustration by Robin Lane"
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            <div className="overflow-hidden rounded-3xl">
              <img
                src={beachCommunity}
                alt="LOBA surf community on the beach"
                className="w-full h-[400px] lg:h-[500px] object-cover"
              />
            </div>
          </ScrollReveal>
          ...
          <div className="space-y-12">
            <ScrollReveal>
              <div className="space-y-4">
                <h3 className="font-heading text-2xl font-bold text-gradient uppercase tracking-wide">
                  Sisterhood
                </h3>
