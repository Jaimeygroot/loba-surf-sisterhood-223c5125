      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <ScrollReveal>
          ...
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
            The surfer is like the wolf — she listens to the environment, moves with nature, and trusts her instincts. LOBA means: a woman who runs with the waves.
          </p>
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
